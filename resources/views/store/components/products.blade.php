<section id="aa-product" class="mt-4" style="margin-top: 20px">
                  ...
                  <div class="tab-content">
                            ...
                            <li>
                                <figure>
                                  <a class="aa-product-img" href="#">
                                    <img style="width:250px; height:300px;" src="{{ asset('storage/' . $product->image) }}" alt="{{ $product->name }}">
                                </a> 
                    ...
                    @else
                      <ul class="aa-product-catg">
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="{{ asset('material/img/man/polo-shirt-2.png')}}" alt="polo shirt img"></a>
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="{{ asset('material/img/man/t-shirt-1.png')}}" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                             <figcaption>
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="{{ asset('material/img/man/polo-shirt-1.png')}}" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                             <figcaption>
                              <h4 class="aa-product-title"><a href="#">Polo T-Shirt</a></h4>
                              <span class="aa-product-price">$45.50</span><span class="aa-product-price"><del>$65.50</del></span>
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="{{ asset('material/img/man/polo-shirt-4.png')}}" alt="polo shirt img"></a>
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                            <figcaption>
                              <h4 class="aa-product-title"><a href="#">Polo T-Shirt</a></h4>
                              <span class="aa-product-price">$45.50</span><span class="aa-product-price"><del>$65.50</del></span>
