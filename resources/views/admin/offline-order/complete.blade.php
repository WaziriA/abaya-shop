        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    ...
                    <p class="mb-0">List of All Orders Completed</p>
                </div>
            </div>
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Order</a></li>
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Offline Complete Orders</a></li>
                </ol>
            </div>
        </div>
        <div class="row">
                            ...
                            <table id="example" class="display" style="min-width: 845px">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>$320,800</td>
                                        <td>2011/04/25</td>
                                        <td><span class="badge badge-success badge-pill text-white">Delivered</span></td>
