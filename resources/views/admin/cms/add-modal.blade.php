<!-- Large Size -->
<div class="modal fade" id="AddModal" tabindex="-1" role="dialog" aria-labelledby="AddModaltModal" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="title" id="AddModalLabel">Add Carousel Item</h4>
            </div>
                                  ...
                                  <div>
                                        <div class="row mb-2">
                                          <div class="col-md-6">
                                            ...
                                            <input type="text" name="up" class="form-control" required>
                                          </div>
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-md-6">
                                               ...
                                               <input type="file" name="photo" id="photoInput" class="form-control" required>
